...
LOCAL_CFLAGS   += -DSUN9IW1P1 -DTARGET_BOARD_PLATFORM=kylin
endif
ifeq ($(TARGET_BOARD_PLATFORM), astar)
LOCAL_CFLAGS   += -DSUN8IW5P1 -DTARGET_BOARD_PLATFORM=astar
endif
ifeq ($(TARGET_BOARD_PLATFORM), octopus)
LOCAL_CFLAGS   += -DSUN8IW6P1 -DTARGET_BOARD_PLATFORM=octopus
endif
endif
